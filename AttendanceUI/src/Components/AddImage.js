...
function AddImg() {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div class="mb-3">
                <label class="form-label">Enter ID to Save:</label>
                <div class="col-sm-10">
                    <input class="form-control" type="text" value={subject} placeholder="Employee ID" onChange={(e) => setsubject(e.target.value)} />
                </div>
            </div>
            <br />
